...
const SPEC: GenerationKey[] = [
  ...
  {
    key: 'discovery.waiver.ack',
    sources: ['Во ред, големината не е проблем — за буџетот од 250 евра почнувам од најголемите станови во понуда.'],
    count: 8,
    instructions: 'Потврди дека големината/бројот на спални НЕ е проблем и кажи дека почнуваш од НАЈГОЛЕМИТЕ станови според буџетот (најголема квадратура прва). Буџетот се вметнува со променливата {budget} — МОРА да ја содржи точно еднаш. Никогаш не спомнувај конкретен број на спални, никогаш не нудеше цена, никогаш не ветувај достапност.',
    required: [/\{budget\}/, /најголем|квадратур/],
    banned: [/\d{2,}\s*евра(?!.?\s*\{budget\})|спални соби би|достапен е|гарантирам/],
    question: false,
  },
  {
  ...
  {
    key: 'investment.opinion',
    sources: ['Ве разбирам. Треба да знаете дека цените ги формираат сопствениците на недвижнините, а не агенцијата — ние сме само посредници меѓу нив и Вас.', 'Цените го следат глобалниот тренд на пазарот. Ние сме само посредници меѓу сопствениците и клиентите, па нашата улога е да го поврземе двете страни.', 'Моменталните цени се реалност која мораме да ја прифатиме на глобално ниво.'],
    count: 10,
    instructions: 'Клиентот изразува мислење за цените на пазарот — дека се превисоки, дека не се паметни за инвестирање, дека пазарот е лош. Агенцијата НЕ одредува цени, тие се од сопствениците. Ние сме посредници. Потврди разбирање, објасни ја улогата на агенцијата. БЕЗ конкретни бројки, БЕЗ цени на имоти, БЕЗ прашалници.',
    required: [/(?:сопственик|одредува|формира|посредник|а?генци|комиси|ренд)/iu],
    banned: [/\d/, /Евидентен|ID|ИД/, /евра|денари/, /надомест/, /\?$/],
    question: false,
  },
  {
    key: 'provision.ask.buy',
    sources: [PROVISION_ANSWER],
    count: 10,
    instructions: 'Клиентот прашува за провизија при КУПУВАЊЕ — објасни дека провизијата за купувачот е 0%, единствен трошок е 500 денари (10 евра) за посета. Обврските на купувачот: адвокат, нотар и данок во Град Скопје. Провизијата е договорена со сопственикот, а купувачот ја купува недвижноста по објавената цена. Задржи ги ТОЧНИТЕ износи.',
    required: [/0\s*%|нула\s+процент/i, /500\s*денари/i, /адвокат/i, /нотар/i, /данок/i],
    banned: [/Евидентен|ID|ИД/],
    question: false,
  },
  {
    key: 'provision.ask.rent',
    sources: [PROVISION_ANSWER],
    count: 10,
    instructions: 'Клиентот прашува за провизија при ИЗНАЈМУВАЊЕ — објасни дека провизијата е 50% од месечната кирија. Сопствениците стандардно бараат: една кирија однапред + депозит. Киријата се плаќа на ден на потписот на договорот. Минимален престој е една година. Половина од месечната кирија е провизијата за агенцијата. Задржи ги ТОЧНИТЕ износи и услови.',
    required: [/50\s*%|педесет\s+процент/i, /депозит/i, /договор/i, /година/i],
    banned: [/Евидентен|ID|ИД/],
    question: false,
  },
  {
    key: 'provision.who.buy',
    sources: [PROVISION_ANSWER],
    count: 10,
    instructions: 'Клиентот прашува КОЈ плаќа адвокат, нотар и данок при купување — објасни дека овие обврски се на купувачот. Адвокатот, нотарот и данокот во Град Скопје се обврска на купувачот. Ова е стандардна процедура. Задржи ги ТОЧНИТЕ зборови: адвокат, нотар, данок, Град Скопје.',
    required: [/адвокат/i, /нотар/i, /данок/i, /купувач/i],
    banned: [/Евидентен|ID|ИД/, /50\s*%/],
    question: false,
  },
  {
    key: 'provision.who.rent',
    sources: [PROVISION_ANSWER],
    count: 10,
    instructions: 'Клиентот прашува КОЈ плаќа адвокат и нотар при ИЗДАВАЊЕ — објасни дека трошоците се по договор меѓу странките. Вообичаена пракса е 50/50. Задржи ги ТОЧНИТЕ зборови: адвокат, нотар, договор, 50/50.',
    required: [/адвокат/i, /нотар/i, /договор/i, /50/i],
    banned: [/Евидентен|ID|ИД/],
    question: false,
  },
  {
    key: 'provision.who.danok.buy',
    sources: [PROVISION_ANSWER],
    count: 10,
    instructions: 'Клиентот прашува КОЈ плаќа ДАНОК при купување — објасни дека данокот во Град Скопје е обврска на купувачот. Се плаќа при регистрација на имотот, при пренос на сопственоста. Задржи ги ТОЧНИТЕ зборови: данок, Град Скопје, купувач, регистрација.',
    required: [/данок/i, /Скопје/i, /купувач/i],
    banned: [/Евидентен|ID|ИД/],
    question: false,
  },
  {
